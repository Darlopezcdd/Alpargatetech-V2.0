@php
    $navLinks = [
        ...
        ['route' => 'audit-logs.index', 'label' => 'Auditoría', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', 'roles' => ['admin']],
    ];
@endphp
            ...
            <a href="{{ route($link['route']) }}" class="{{ $isActive
                ...
                <svg class="{{ $isActive
                    ...
                    : 'text-gray-500 group-hover:text-brand-gold transition-colors duration-300' 
                           }} mr-3 flex-shrink-0 h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
